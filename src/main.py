...
def solveEveryInstance(solname="cur_solution.zip"):
    ...
    debugSeed = 51645591#754181797#267012647
    debugIdxs = None#[125]#[114]#64#7#8#88
    debugUID = None#"simple-polygon-exterior-20_20_0f96fb2c"#"simple-polygon-exterior-20_10_8c4306da"#point-set_10_13860916"
...
def pooledWorkerFunction(index):
    ...
    try:
        ...
        lock.acquire()
        logging.error(f"{multiprocessing.current_process()} ({myIdx}): working on instanceId {instanceIdx} of name {instance.instance_uid} with seed {seed} FAILED WITH AN ERROR...")
        lock.release()
    else:
        lock.acquire()
...
def mergeEveryInstance():
    ...
    for instance in idb:
        if i != 7:
            ...
            backup = [('14975', '10150'), ('14775', '10150'), ('14675', '10150'), ('12225', '9375'), ('12225', '9275'), ('12075', '9125'), ('12075', '9225'), ('12075', '9425'), ('12075', '9525'), ('11500', '10600'), ('10850', '9400'), ('10850', '9175'), ('10900', '8875'), ('11800', '8875'), ('12100', '8875'), ('12425', '6925'), ('12425', '6775'), ('11700', '6150'), ('11500', '6150'), ('8425', '5700'), ('8225', '5700'), ('8125', '5700'), ('8675', '7700'), ('8675', '7800'), ('8675', '7900'), ('8675', '8000'), ('8675', '8100'), ('8675', '8200'), ('8675', '8300'), ('8675', '8400'), ('8675', '8500'), ('8525', '10150'), ('8425', '10150'), ('5550', '8875'), ('5525', '9225'), ('5675', '9275'), ('5675', '9375'), ('5525', '9425'), ('5525', '9525'), ('5150', '10600'), ('4950', '10600'), ('4300', '9400'), ('4300', '9175'), ('5875', '7075'), ('5875', '6925'), ('5875', '6775'), ('5150', '6150'), ('4300', '5050'), ('4300', '4950'), ('4300', '4725'), ('4500', '4425'), ('4950', '4425'), ('5250', '4425'), ('5525', '4775'), ('5525', '4975'), ('5525', '5075'), ('5675', '4925'), ('5675', '4825'), ('5550', '4425'), ('5875', '2625'), ('8675', '3350'), ('8675', '3450'), ('8675', '3550'), ('8675', '3650'), ('8675', '3750'), ('8675', '3850'), ('8675', '4050'), ('10850', '5050'), ('10850', '4950'), ('10850', '4825'), ('10850', '4725'), ('10900', '4425'), ('11500', '4425'), ('12075', '4675'), ('12075', '4775'), ('12075', '5075'), ('12225', '4825'), ('12100', '4425'), ('12425', '2775'), ('12425', '2625'), ('12425', '2475'), ('15225', '3150'), ('15225', '3450'), ('15225', '3550'), ('15225', '3650'), ('15225', '3750'), ('15225', '3850'), ('15225', '4050'), ('15075', '5700'), ('14775', '5700'), ('14675', '5700'), ('15225', '7600'), ('15225', '7900'), ('15225', '8000'), ('15225', '8100'), ('15225', '8200'), ('15225', '8300'), ('15225', '8400'), ('15225', '8500'), ('15075', '10150'), ('11500', '4750'), ('52117/10', '4975'), ('651224968/52825', '993909967/105650'), ('11800', '9200'), ('61726/5', '93531/10'), ('117425/9', '2625'), ('34253/5', '20303/5'), ('59102/5', '9425'), ('365862/25', '3650'), ('27549/5', '18575/2'), ('115113/10', '4950'), ('9081/2', '19023/4'), ('240399543/53696', '4950'), ('28225/4', '4825'), ('8059', '6381/2'), ('5150', '94347/10'), ('19027/4', '8566'), ('62786/5', '44678/5'), ('303594401882442725/20121062788301', '164000405620000350/20121062788301'), ('8349636325749555/549755813888', '8000'), ('149099/10', '32207/10'), ('51601/10', '91869/10'), ('42458/5', '84939/10'), ('25312425/2939', '8300'), ('18382250/1717', '10360050/1717'), ('83113/10', '7800'), ('14775', '8257/2'), ('125037/10', '6922'), ('62496/5', '5274'), ('82127/10', '3650'), ('145863/10', '76771/10'), ('66891/5', '20792/5'), ('7780475/1244', '7220675/1244'), ('8350186081563443/549755813888', '8300'), ('168166/25', '218064/25'), ('22779607675/2695063', '8200'), ('8630', '8000'), ('66351/10', '6925'), ('991713037/66365', '409086279/132730'), ('151901/10', '3850'), ('14775', '84747/10'), ('14975', '101409/10'), ('512506517/79130', '3674006179/395650'), ('15208', '3450'), ('43249/5', '3850'), ('2374340384600883/274877906944', '3450'), ('8225', '2426483702035907782002377071/604462909807314587353088')]
            ...
            bestTri = Triangulation(instance,False,0,axs,True,[Point(FieldNumber(t[0]),FieldNumber(t[1])) for t in backup[len(instance.points_x):]])#triangulationFromSolution(instance,bestSolution,axs=axs)
...
if __name__=="__main__":
    ...
    if args.parallel:
        ...
        #np.random.seed(1337)
        #seeds = [np.random.randint(0,1000000000) for i in range(1)]
        #print(seeds)
