...
def solveEveryInstance(solname="cur_solution.zip"):
    ...
    debugUID = "simple-polygon-exterior-20_20_0f96fb2c"#"simple-polygon-exterior-20_10_8c4306da"#point-set_10_13860916"
...
def triangulationFromSolution(instance,solution):
